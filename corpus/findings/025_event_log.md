---
tags: [event-log, query, filter, operator, paging, write, create, serializable, status, trap, silent]
endpoints: [POST /entity/<type>/_search, POST /entity/<type>, DELETE /entity/<type>/<id>, GET /schema/<Type>/fields]
phase: observe
scope: api
